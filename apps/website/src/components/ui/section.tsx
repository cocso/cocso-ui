...
const SectionTitle = ({ className, ...props }: SectionTitleProps) => {
  return (
    <h2
      className={twMerge("mb-2 font-semibold text-xl", className)}
      {...props}
    />
  );
};
...
const SectionText = ({ className, ...props }: SectionTextProps) => {
  return (
    <div
      className={twMerge("text-neutral-800 leading-relaxed", className)}
      {...props}
    />
  );
};
...
const SectionUnorderedList = ({
  className,
  ...props
}: SectionUnorderedListProps) => {
  return (
    <ul
      className={twMerge(
...
const SectionOrderedList = ({
  className,
  ...props
}: SectionOrderedListProps) => {
  return (
    <ol
      className={twMerge(
...
const SectionListItem = ({ className, ...props }: SectionListItemProps) => {
  return (
    <li
      className={twMerge(
        "pl-1 font-normal text-neutral-800 leading-relaxed",
        className
      )}
      {...props}
    />
