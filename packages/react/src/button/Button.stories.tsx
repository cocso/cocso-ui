  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
      ...
      <div>
        ...
        <div style={{ display: 'flex', gap: '12px', alignItems: 'center', flexWrap: 'wrap' }}>
          <Button prefix={<PlusIcon size={14} />} size="xs">
            Add
          </Button>
          <Button prefix={<PlusIcon size={16} />} size="sm">
            Add Item
          </Button>
          <Button prefix={<PlusIcon size={18} />} size="md">
            Add Item
          </Button>
          <Button prefix={<PlusIcon size={20} />} size="lg">
            Add New Item
          </Button>
          <Button prefix={<PlusIcon size={22} />} size="xl">
            Add New Item
          </Button>
        </div>
      </div>
      ...
      <div>
        ...
        <div style={{ display: 'flex', gap: '12px', alignItems: 'center', flexWrap: 'wrap' }}>
          <Button prefix={<SearchIcon size={14} />} size="xs" suffix={<CheckIcon size={14} />}>
            Find
          </Button>
          <Button prefix={<SearchIcon size={16} />} size="sm" suffix={<CheckIcon size={16} />}>
            Search
          </Button>
          <Button prefix={<SearchIcon size={18} />} size="md" suffix={<CheckIcon size={18} />}>
            Search & Verify
          </Button>
          <Button prefix={<SearchIcon size={20} />} size="lg" suffix={<CheckIcon size={20} />}>
            Search & Verify
          </Button>
          <Button prefix={<SearchIcon size={22} />} size="xl" suffix={<CheckIcon size={22} />}>
            Search & Verify
          </Button>
        </div>
      </div>
...
export const VariantShowcase: Story = {
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
      {['primary', 'secondary', 'tertiary', 'success', 'error', 'warning', 'neutral'].map(
        variant => (
          <div key={variant}>
            <h4
              style={{
            ...
            <div style={{ display: 'flex', gap: '12px', alignItems: 'center', flexWrap: 'wrap' }}>
              ...
              <Button prefix={<PlusIcon size={16} />} variant={variant as any}>
                With Prefix
              </Button>
              <Button suffix={<SettingsIcon size={16} />} variant={variant as any}>
                With Suffix
              </Button>
              <Button
              ...
              <Button loading variant={variant as any}>
                Loading
              </Button>
              <Button svgOnly variant={variant as any}>
                <PlusIcon size={16} />
              </Button>
            </div>
          </div>
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
      ...
      <div>
        ...
        <div style={{ display: 'flex', gap: '12px', alignItems: 'center', flexWrap: 'wrap' }}>
          <Button prefix={<PlusIcon size={16} />} shape="square">
            Square
          </Button>
          <Button prefix={<PlusIcon size={16} />} shape="rounded">
            Rounded
          </Button>
          <Button shape="circle" svgOnly>
            <PlusIcon size={16} />
