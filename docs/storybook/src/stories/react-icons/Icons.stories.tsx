  ...
  render: () => {
    ...
    return (
      <div style={{ width: '100%', maxWidth: '1200px' }}>
        <IconGrid icons={categories.brand} showNames={true} size={32} title="Brand Icons" />
      </div>
    );
  },
};
...
export const SemanticIcons: Story = {
  render: () => {
    ...
    return (
      <div style={{ width: '100%', maxWidth: '1200px' }}>
        <IconGrid icons={categories.semantic} showNames={true} size={32} title="Semantic Icons" />
      </div>
    );
  },
};
...
export const GraphicIcons: Story = {
  render: () => {
    ...
    return (
      <div style={{ width: '100%', maxWidth: '1200px' }}>
        <IconGrid icons={categories.graphic} showNames={true} size={32} title="Graphic Icons" />
      </div>
    );
  },
};
