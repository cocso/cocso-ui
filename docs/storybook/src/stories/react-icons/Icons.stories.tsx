...
const categorizeIcons = () => {
  ...
  const categories: { [key: string]: { [key: string]: ComponentType<IconProps> } } = {
    brand: {},
    semantic: {},
    graphic: {},
    other: {},
...
const IconGrid = ({
  ...
  icons: { [key: string]: ComponentType<IconProps> };
  title: string;
  size?: number;
  showNames?: boolean;
  showColors?: boolean;
    ...
    return (
      ...
      >
        <h2 style={{ marginBottom: '20px', fontSize: '24px', fontWeight: 'bold' }}>
          All React Icons (
          {Object.values(categories).reduce((acc, cat) => acc + Object.keys(cat).length, 0)} total)
        </h2>
  ...
  render: () => {
    ...
    return (
      <div style={{ width: '100%', maxWidth: '1200px' }}>
        <IconGrid icons={categories.brand} title="Brand Icons" size={32} showNames={true} />
      </div>
    );
  },
};
...
export const SemanticIcons: Story = {
  render: () => {
    ...
    return (
      <div style={{ width: '100%', maxWidth: '1200px' }}>
        <IconGrid icons={categories.semantic} title="Semantic Icons" size={32} showNames={true} />
      </div>
    );
  },
};
...
export const GraphicIcons: Story = {
  render: () => {
    ...
    return (
      <div style={{ width: '100%', maxWidth: '1200px' }}>
        <IconGrid icons={categories.graphic} title="Graphic Icons" size={32} showNames={true} />
      </div>
    );
  },
};
