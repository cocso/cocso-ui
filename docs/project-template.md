...
Examples: `Next.js 16 (TypeScript)`, `Expo React Native`.
...
Include route patterns, API boundaries, and integration contracts.
...
- [ ] File name uses `project-` prefix and kebab-case ID.
...
- [ ] Integration points reference canonical rules in `AGENTS.md`.
- [ ] The document is committed in the same change as the path skeleton creation.
